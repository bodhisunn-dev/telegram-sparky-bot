-- Update mention-random-users cron job from every 30 minutes to every 3 hours
SELECT cron.unschedule('mention-random-users-every-30-min');

SELECT cron.schedule(
  'mention-random-users-every-3-hours',
