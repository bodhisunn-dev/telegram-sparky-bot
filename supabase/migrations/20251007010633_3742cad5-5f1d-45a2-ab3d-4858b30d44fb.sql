-- Schedule top active users shoutout every 12 hours (at 00:00 and 12:00)
SELECT cron.schedule(
  'top-active-shoutout-every-12-hours',
  '0 */12 * * *',
  $$
  SELECT
    net.http_post(
      url:='https://eptbjrnqydvkkplousle.supabase.co/functions/v1/top-active-shoutout',
